...
extension PostTableViewCell {
    private func setupGesture() {
        ...
        self.tapPostsGestureRecognizer.addTarget(self, action: #selector(self.postHandleTapGesture(_:)))
    ...
    @objc func postHandleTapGesture(_ gestureRecognizer: UITapGestureRecognizer) {
