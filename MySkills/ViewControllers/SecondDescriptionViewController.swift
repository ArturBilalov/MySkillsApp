...
class SecondDescriptionViewController: UIViewController {
    ...
    private lazy var infoLabel1: UILabel = {
        let label = UILabel()
        label.text = infoText.labelForSecondDescriptionViewController1
    ...
    private lazy var infoLabel2: UILabel = {
        let label = UILabel()
        label.text = infoText.labelForSecondDescriptionViewController2
        label.textAlignment = .natural
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.layer.cornerRadius = 12
    ...
    private lazy var infoLabel3: UILabel = {
        let label = UILabel()
        label.text = infoText.labelForSecondDescriptionViewController3
        label.textAlignment = .natural
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.layer.cornerRadius = 12
    ...
    private lazy var infoLabel4: UILabel = {
        let label = UILabel()
        label.text = infoText.labelForSecondDescriptionViewController4
        label.textAlignment = .natural
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.layer.cornerRadius = 12
